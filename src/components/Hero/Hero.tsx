...
export const Hero = forwardRef<HTMLDivElement, { onKnowMoreClick: () => void }>(({ onKnowMoreClick }, ref) => (
  <section
    ref={ref}
  ...
  >
    <div className="flex min-[750px]:flex-row flex-col-reverse justify-center gap-12 items-center">
      <div>
        ...
        <RotatingBorderButton className="mt-6 max-[750px]:mx-auto" label="En savoir plus" onClick={onKnowMoreClick} />
      </div>
